...
const Testimonials = () => {
  return (
    ...
    <div className="w-full h-fit p-10 bg-gradient-to-br from-black/70 to-black/10 mt-10 flex flex-col items-center justify-center space-y-5">
        <p className="text-5xl font-bold text-white text-center">Testimonials</p>
        <div className="w-full flex p-2 flex-col lg:flex-row items-center justify-center space-y-5 lg:space-y-0 lg:space-x-10">
            <div className="w-[90%] lg:w-[40%] h-fit cursor-pointer hover:scale-110 duration-150 ease-linear p-2 bg-black/30 rounded-lg shadow-lg">
                <div className="w-full p-2 h-1/2 flex flex-col items-center justify-center">
                    ...
                    <p className="text-lg text-white/70 font-bold text-center">
                    Sham Kharat
                    </p>
                </div>
            </div>
