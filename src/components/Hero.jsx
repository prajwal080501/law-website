  ...
  return (
    <div className="w-screen h-1/2 flex flex-col items-center justify-center mt-10">
      <div className="w-3/4 h-3/4 space-y-5 flex flex-col items-center justify-center">
        ...
        <p Adv className="text-4xl lg:text-5xl font-extrabold tracking-wide text-transparent w-full text-center bg-gradient-to-r from-pink-500 to-blue-600 bg-clip-text">Adv Rajan Ladkat</p>
